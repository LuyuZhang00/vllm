// =============================================================================
// 中文注释：MoE WNA16 量化 GEMM 工具文件
//
// 本文件提供了 WNA16 (Weight-Only N-bit with 16-bit activation) 量化 MoE GEMM
// 所需的标量类型转换工具类。
//
// ScalarType<> 模板特化（half, nv_bfloat16）提供了以下功能：
// - num2float / float2num：标量类型与 float 之间的转换
// - num2num2 / nums2num2：标量类型到 2 元素向量类型的转换
// - num22float2 / float22num2：2 元素向量类型与 float2 之间的转换
//
// 这些转换函数用于在量化权重反量化和矩阵乘法累加过程中进行类型转换。
// =============================================================================

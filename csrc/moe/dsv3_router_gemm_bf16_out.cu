...
// =============================================================================
// 中文注释：DeepSeek V3 Router GEMM kernel（bf16 输出版本）
//
// 本文件实现了 DSV3 Router GEMM 的 bf16 输出版本。
// 与 float_out 版本相比，输出直接写入 bf16，省去了 float->bf16 的转换开销。
// 适用于对精度要求不高的场景（如路由得分本身精度有限）。
//
// 线程组织和算法与 float_out 版本相同，区别仅在于输出类型和累加精度。
// =============================================================================
